...
area_adj_tt_list <- area_adj_tt_list %>% 
  mutate(travel_time_adj = ifelse(travel_time_adj <= 1, 1, travel_time_adj)) %>%  
...
od <- od |>
  mutate(f_exp = dexp(travel_costs, rate = 0.05560581),
         f_gamma = dgamma(travel_costs, shape = 1.60289258, rate = 0.08911374),
         f_bin = ifelse(travel_costs > 20, 0, 1))
